  ...
  export default function CookiePolicy(
    {
      ...
      textToUrl = "Read our cookie policy",
      url = "https://www.deco.cx/en",
      button = "Allow",
    }: Props,
  ) {
    return (
      <div class="container fixed bottom-0 right-0 left-0 w-11/12 my-5 mx-auto p-5 bg-white shadow-[0px_10px15px-3px_rgba(0,0,0,0.1),0px_4px6px-2px_rgba(0,0,0,0.05)]">
        <div class="firstLine flex justify-between items-center py-2">
          ...
          <div>
            <button
              type="button"
              class="bg-transparent rounded-md p-2 inline-flex items-center justify-center text-[#292929] " data-button-closed
            >
